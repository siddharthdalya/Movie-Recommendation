...
public class CalculateCosineSimilarity {
	 ...
	 * @return
	 */
	public static final List<UserSimilarityObject> calculateCosineSimilarity(Matrix inputMatrix, int userid, int inputMovieid,int kValue) {
	 ...
	 * @return
	 */
	public static final double calculateMovieRating(Matrix inputMatrix,List<UserSimilarityObject> tempKSimilarityObjList, int userid, int inputMovieid, int kValue) {
